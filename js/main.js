 ...
 * @todo OK (Review) Accessbility: add ARIA roles and labels
 *	OK index.html's map:
 ...
 *	OK restaurant.html:
 *		OK aria role and aria-label for map
 *		OK aria-label for breadcrumb
 */
...
initMap = () => {
	...
	L.tileLayer('https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.jpg70?access_token={mapboxToken}', {
		mapboxToken: 'pk.eyJ1Ijoic3RyaWRlcjg1IiwiYSI6ImNqbm5xeDNmdzI5YmszcW9qNWhnemF5NWQifQ.EALt7nbSvBWo-shZNNCtog',
		maxZoom: 18,
...
createRestaurantHTML = (restaurant) => {
	...
	image.setAttribute("alt", "Restaurante image");
	li.append(image);
